...
class ProductCard extends StatelessWidget {
  ...
  const ProductCard({Key? key, required this.image, required this.title, required this.unit, required this.price, required this.mrp, required this.discount, this.onTap}) : super(key: key);
          ...
          child: Column(
            ...
            children: [
              ...
              Padding(
                ...
                child: Row(
                  children: [
                    Text('Save ₹${mrp- price}', style: const TextStyle(fontSize: 11)),
                    const Spacer(),
                    SizedBox(
                      width: 64,
